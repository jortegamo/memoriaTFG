...
\item \label{r18} No se podrá borrar ningun contenido con subcontenidos.
...
\end{enumerate}
\item \textbf{Fase 3 - Final:} una vez implementado el prototipo final se ha procedido a la fase final del proyecto que corresponde a la mejora global y su despliegue.
\end{itemize}
\begin{figure}[t]
\centering
\includegraphics[scale=0.7]{fbackM.png}
