...
En este capítulo se expone el problema que impulsa la motivación de realizar este proyecto, los objetivos y requisitos marcados, la metodología elegida para su desarrollo y el plan de trabajo llevado a cabo adoptando dicha metodología. Además se enumeran tecnologías que sirven de inspiración al mismo.
\section{Motivación}
\paragraph{}
...
Como resultado del análisis motivación descrita, podemos extraer una serie de objetivos generales que deben de cumplirse en la implementación de este proyecto. Estos objetivos son: 
\begin{enumerate}
\item Desarrollar una aplicación funcional y que sirva de herramienta para los desarrolladores en tiempo real.
\item La aplicación debe ser atractiva al usuario e intuitiva atendiendo a las bases UX (User Experience) más importantes.
\item La aplicación debe ser fluida y estar optimizada. 
\item La aplicación debe constituir una herramienta didáctica cuyo elemento de información base sea visual e interactivo.
\end{enumerate}
...
\paragraph{}
En el siguiente capítulo se describe detalladamente el diseño y desarrollo de cada los prototipos más relevantes que se han implementado a lo largo del proyecto.
