...
En este apéndice se muestra ejemplos de código para un correcto seguimiento de la implementación descrita en cada uno de los prototipos del capítulo 4. Estos fragmentos no corresponden al código fuente del proyecto ya que su fin es ilustrar y funcionar a modo de ejemplo.
