...
\paragraph{}
Para conocer la historia del desarrollo web es necesario remontarse a los orígenes de \emph{Internet}. En 1969 se crea la primera red de comunicación interconectada entre dos computadoras de dos universidades estadounidenses llamada \textbf{ARPAnet}\footnote{https://es.wikipedia.org/wiki/ARPANET} (Advanced Research Projects Agency Network o Red de la Agencia para los Proyectos de Investigación Avanzada de los Estados Unidos) que funcionaba con un protocolo de intercambio de paquetes llamado \textbf{TCP/IP}\footnote{\url{https://es.wikipedia.org/wiki/Modelo_TCP/IP}}. En 1986 comenzó la construcción de la primera infraestructura en forma de árbol de Internet llamada \textbf{NSFNET}\footnote{\url{https://es.wikipedia.org/wiki/NSFNet}} la cual se complementó con otras redes en EEUU y en Europa formando el \emph{backbone} o red troncal básica de Internet.  
\paragraph{}
...
\paragraph{}
El desarrollo web comprende todo el proceso de creación de un sitio web. La elección de las herramientas a utilizar, de diseño y desarrollo, qué metodología seguir, prototipado, propuesta final y lanzamiento.
\paragraph{}
...
\paragraph{}
En el apéndice \ref{appendix:meteor} se describen detalladamente más características de este framework englobando los fundamentos básicos de MongoDB y su interacción con el mismo.
...
\item \textbf{Capítulo 4: } en él se detalla el proceso de diseño y desarrollo. Se ha organizado en función de los prototipos de los que consta este proyecto y se han presentado los más relevantes.
...
\item \textbf{Apéndices: } esta apartado está compuesto por seis capítulos y su finalidad es servir de apoyo al lector de esta memoria.
\end{itemize}