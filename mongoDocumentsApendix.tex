\chapter{Diseño de documentos para MongoDB}\label{appendix:documentsdesign}
En este apéndice se muestra el diseño de los objetos BSON para cada una de las entidades.
\vspace{1cm}
