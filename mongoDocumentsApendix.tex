\chapter{Diseño de la base de datos y documentos para MongoDB}
En este apéndice se muestra el esquema Entidad Relación y los objetos BSON diseñados para cada una de las entidades.
